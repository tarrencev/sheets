...
var SheetCell = React.createClass({
    ...
    render: function render() {
        ...
        return React.createElement(
            ...
            React.createElement("input", { type: "value",
    ...
    _handleChange: function _handleChange(ev) {
        this.props.cell.update("value", function () {
            return ev.target.value;
        });
    },

    _handleKeyUp: function _handleKeyUp(ev) {
        ...
        if (value && value.substring(0, 1) === "=") {
            ...
            this.props.cell.update("value", function () {
                return eval(ev.target.value.slice(1));
            });
        }
    }
});
